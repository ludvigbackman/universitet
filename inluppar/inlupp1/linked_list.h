 ...
 * @date 30 Sep 2021
 * @brief Simple linked list with integers.
 */
...
/// @brief Tear down the linked list and return all its memory and the memory of the elements
...
/// the last element.
/// An invalid index will be change to 0 if index is negative and 
/// to n if index is larger that n.
...
/// @param index the position in the list
/// @return an bool dertermening if the remove targeted a valid index
/// and the value just removed
...
/// @param list the linked list that will be extended
/// @param index the position in the list
/// @return an bool dertermening if it was a valid index
/// and the value got
