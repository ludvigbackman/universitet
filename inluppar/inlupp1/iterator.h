...
/// @param iter the iterator
/// @return a struct with an bool dertermening if there was a next element
/// and the value of that element
option_t ioopm_iterator_next(ioopm_list_iterator_t *iter);

/// @brief Remove the current element from the underlying list
/// @param iter the iterator
/// @return a struct with a bool determening if there was a current element
/// and the element removed
...
/// @param iter the iterator
/// @return a struct with an bool dertermening if it was a current elememnt (list could be empty)
/// and the element
